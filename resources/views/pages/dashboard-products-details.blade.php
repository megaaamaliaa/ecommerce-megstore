                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nameStore" id="nameStore" class="form-control" value="Papel La Casa">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <button class="btn btn-secondary btn-block mt-2" onclick="thisFileUpload()">Add New Photo</button>
                            </div>
                        </div>
                    </div>
                </div>
