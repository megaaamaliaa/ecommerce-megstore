...
@section('content')
    ...
    <div class="page-content page-cart">
      <section class="store-breadcrumbs" data-aos="fade-down" data-aos-deay="100">
        <div class="container">
          <div class="row">
            <div class="col-12">
       ...
       <section class="store-cart">
        <div class="container">
                ...
                <tbody>
                  <tr>
                    ...
                    <td style="width: 35%;">
                      ...
                      <div class="product-subtitle">by Mega Amalia</div>
                    </td>
                    <td style="width: 35%;">
                      <div class="product-title">$32</div>
          ...
          <!-- shipping details -->
          <div class="row" data-aos="fade-up" data-aos-deay="150">
            <div class="col-12">
              <hr>
            </div>
            <div class="col-12">
